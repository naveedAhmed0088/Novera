...
/**
 This constant takes place in dequeing supplementary views for list headers.
 */
extern NSString *const __nonnull TKListViewElementKindListHeader;

/**
 This constant takes place in dequeing supplementary views for list footers.
 */
extern NSString *const __nonnull TKListViewElementKindListFooter;
 ...
 */
- (BOOL)listView:(TKListView * __nonnull)listView shouldLoadMoreDataAtIndexPath:(NSIndexPath*) indexPath;
...
/**
 Indicates whether the section headers should stick on the top of the TKListView.
 */
@property (nonatomic) BOOL sectionHeadersSticky;
...
- (TKListViewLinearLayout*)createLayout;
