...
public class PlatformEventsBasedInteractionHelper_GestureListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Telerik.Maui.Controls.PlatformEventsBasedInteractionHelper+GestureListener, Telerik.Maui.Controls", PlatformEventsBasedInteractionHelper_GestureListener.class, __md_methods);
	}


	public PlatformEventsBasedInteractionHelper_GestureListener ()
	{
		super ();
		if (getClass () == PlatformEventsBasedInteractionHelper_GestureListener.class) {
			mono.android.TypeManager.Activate ("Telerik.Maui.Controls.PlatformEventsBasedInteractionHelper+GestureListener, Telerik.Maui.Controls", "", this, new java.lang.Object[] {  });
		}
	}
