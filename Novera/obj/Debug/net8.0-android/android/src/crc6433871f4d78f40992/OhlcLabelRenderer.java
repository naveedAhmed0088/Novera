...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Telerik.Maui.Controls.Compatibility.ChartRenderer.Android.OhlcLabelRenderer, Telerik.Maui.Controls.Compatibility", OhlcLabelRenderer.class, __md_methods);
	}
	...
	public OhlcLabelRenderer (com.telerik.widget.chart.visualization.common.ChartSeries p0)
	{
		...
		if (getClass () == OhlcLabelRenderer.class) {
			mono.android.TypeManager.Activate ("Telerik.Maui.Controls.Compatibility.ChartRenderer.Android.OhlcLabelRenderer, Telerik.Maui.Controls.Compatibility", "Com.Telerik.Widget.Chart.Visualization.Common.ChartSeries, Telerik.Android.Chart", this, new java.lang.Object[] { p0 });
		}
	}
