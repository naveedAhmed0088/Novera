...
/**
 The legend items shape.
 */
@property (nonatomic, assign) TKShapeType legendItemsIconShape;

/**
 The legend items size.
 */
@property (nonatomic, assign) CGRect legendItemsIconSize;
