...
- (instancetype __nonnull)initWithX:(id __nullable)xValue open:(NSNumber * __nullable)open high:(NSNumber * __nullable)high low:(NSNumber * __nullable)low close:(NSNumber * __nullable)close name:(NSString * __nullable)name;
