...
- (CGSize)listView:(TKListView *__nonnull)listView layout:(TKListViewLinearLayout *__nonnull)layout sizeForSupplementaryElementOfKind:(NSString * __nonnull)kind atIndexPath:(NSIndexPath * __nonnull)indexPath;
...
/**
 The list header reference size.
 */
@property (nonatomic) CGSize listHeaderReferenceSize;

/**
 The list footer reference size.
 */
@property (nonatomic) CGSize listFooterReferenceSize;

/**
 The group header reference size.
 */
@property (nonatomic) CGSize headerReferenceSize;

/**
 The group footer reference size.
 */
@property (nonatomic) CGSize footerReferenceSize;

/**
 Determine header size by calling the sizeThatFits method for each cell.
 */
@property (nonatomic) BOOL dynamicHeaderSize;

/**
 Determine footer size by calling the sizeThatFits method for each cell.
 */
@property (nonatomic) BOOL dynamicFooterSize;
...
/**
 Initializes the list header layout attributes.
 @param attributes The attributes to initialize.
 @param point The current location.
 */
- (CGPoint)initListHeaderAttributes:(UICollectionViewLayoutAttributes* __nonnull)attributes atPoint:(CGPoint)point;

/**
 Initializes the list footer layout attributes.
 @param attributes The attributes to initialize.
 @param point The current location.
 */
- (CGPoint)initListFooterAttributes:(UICollectionViewLayoutAttributes* __nonnull)attributes atPoint:(CGPoint)point;
...
- (UICollectionViewLayoutAttributes *)layoutAttribute:(UICollectionViewLayoutAttributes*)attribute inRect:(CGRect)rect;
